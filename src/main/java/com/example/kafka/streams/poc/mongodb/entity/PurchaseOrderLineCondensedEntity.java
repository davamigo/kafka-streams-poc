...
/**
 * Purchase order line condensed MongoDB entity (to be used inside purchase order entity)
 */
public class PurchaseOrderLineCondensedEntity {
     ...
     * Empty constructor
     */
    public PurchaseOrderLineCondensedEntity() {
    }
     ...
     */
    public PurchaseOrderLineCondensedEntity(PurchaseOrderLineCondensed source) {
